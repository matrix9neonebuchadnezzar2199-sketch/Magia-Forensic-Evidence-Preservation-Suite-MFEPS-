...
from src.utils.error_codes import ALL_ERROR_CODES, category_for_code, E10001
...
class TestErrorCodes:
    ...
    def test_format_e_digits(self):
        pat = re.compile(r"^E\d{4,5}$")
    ...
    def test_category_for_code(self):
        ...
        assert category_for_code(E10001.code) == "remote"
